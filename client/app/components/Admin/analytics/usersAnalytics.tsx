...
import { useGetUsersAnalyticsQuery } from "@/redux/features/analytics/analytics.api";
...
const UserAnalytics = ({ isDashboard }: Props) => {
  ...
  data &&
    data.users.lastOneYearData.forEach((item: any) => {
  ...
  return (
    <>
      {isLoading ? (
        ...
        <div
          className={`${
            !isDashboard ? "mt-[50px]" : "mt-[50px] dark:bg-[#111C43] shadow-sm pb-5 rounded-sm"
          }`}
        >
