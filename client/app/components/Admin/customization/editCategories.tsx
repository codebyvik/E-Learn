...
const EditCategories = (props: Props) => {
  ...
  const handleCategoriesAdd = (id: any, value: string, index: any) => {
    setCategories((prevCategory: any) =>
      prevCategory.map((i: any) =>
        i._id === id ? { ...i, title: value } : i._id === index ? { ...i, title: value } : i
      )
    );
  };
  ...
  const newCategoriesHandler = () => {
    if (categories[categories.length - 1].title === "") {
      ...
      const id: any = categories.length - 1;
      setCategories([...categories, { _id: id, title: "" }]);
    }
  };
