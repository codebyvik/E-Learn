...
exports.deleteUser = exports.updateUserRole = exports.getAllUsers = exports.updateAvatar = exports.updateUserPassword = exports.updateUserInfo = exports.socialAuth = exports.getUserInfo = exports.updateAccessToken = exports.logoutUser = exports.signInUser = exports.activateUser = exports.createActivationToken = exports.registerUser = void 0;
...
exports.signInUser = (0, catchAsyncError_1.default)(async (req, res, next) => {
    try {
        ...
        if (!user) {
            return next(new errorHandler_1.default("User not found , please register", 404));
        }
...
// logout user
exports.logoutUser = (0, catchAsyncError_1.default)(async (req, res, next) => {
    try {
...
// update access token
exports.updateAccessToken = (0, catchAsyncError_1.default)(async (req, res, next) => {
    try {
...
// get user info
exports.getUserInfo = (0, catchAsyncError_1.default)(async (req, res, next) => {
    try {
...
exports.socialAuth = (0, catchAsyncError_1.default)(async (req, res, next) => {
    try {
...
exports.updateUserPassword = (0, catchAsyncError_1.default)(async (req, res, next) => {
    try {
...
exports.updateAvatar = (0, catchAsyncError_1.default)(async (req, res, next) => {
    try {
        ...
        if (avatar && user) {
            if (user?.avatar?.public_id) {
                ...
                const avatarUploadInfo = await cloudinary_1.default.v2.uploader.upload(avatar, {
                    folder: "avatars",
                    width: 150,
                });
                user.avatar = {
